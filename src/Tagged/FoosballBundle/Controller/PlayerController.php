...
use Tagged\FoosballBundle\Form\PlayerType;
...
class PlayerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TaggedFoosballBundle:Player')->findAllOrderedByScore();
     ...
     * @Method("POST")
     * @Template("TaggedFoosballBundle:Player:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TaggedFoosballBundle:Player')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TaggedFoosballBundle:Player:edit.html.twig")
     */
